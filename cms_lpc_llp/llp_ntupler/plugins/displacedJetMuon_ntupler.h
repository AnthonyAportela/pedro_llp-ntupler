...
public:
  ...
  bool fillTaus();
  bool checkNMuonClusters(const edm::Event& iEvent, const edm::EventSetup& iSetup);
...
float pho_pfClusterSeedE[OBJECTARRAYSIZE];
 ...
 float hoRechit_Z[HORECHITARRAYSIZE];
  ...
  float dtRechitCorrectX[CSCRECHITARRAYSIZE];
  float dtRechitCorrectY[CSCRECHITARRAYSIZE];
  float dtRechitCorrectZ[CSCRECHITARRAYSIZE];
  float dtRechitCorrectEta[CSCRECHITARRAYSIZE];
  float dtRechitCorrectPhi[CSCRECHITARRAYSIZE];
  float dtRechitTime[CSCRECHITARRAYSIZE];
  int dtRechitStation[CSCRECHITARRAYSIZE];
  int dtRechitWheel[CSCRECHITARRAYSIZE];
  int dtRechitSector[CSCRECHITARRAYSIZE];
  int dtRechitLayer[CSCRECHITARRAYSIZE];
  int dtRechitSuperLayer[CSCRECHITARRAYSIZE];
  ...
  float fatJetElectronEnergyFraction[OBJECTARRAYSIZE];
  float fatJetPhotonEnergyFraction[OBJECTARRAYSIZE];
  float fatJetChargedHadronEnergyFraction[OBJECTARRAYSIZE];
  float fatJetNeutralHadronEnergyFraction[OBJECTARRAYSIZE];
  float fatJetMuonEnergyFraction[OBJECTARRAYSIZE];
  float fatJetHOEnergyFraction[OBJECTARRAYSIZE];
  float fatJetHFHadronEnergyFraction[OBJECTARRAYSIZE];
  float fatJetHFEMEnergyFraction[OBJECTARRAYSIZE];
  int   fatJetChargedHadronMultiplicity[OBJECTARRAYSIZE];
  int   fatJetNeutralHadronMultiplicity[OBJECTARRAYSIZE];
  int   fatJetElectronMultiplicity[OBJECTARRAYSIZE];
  int   fatJetPhotonMultiplicity[OBJECTARRAYSIZE];
  int   fatJetMuonMultiplicity[OBJECTARRAYSIZE];
  int   fatJetNSV[OBJECTARRAYSIZE];
  int   fatJetNSVCand[OBJECTARRAYSIZE];
  int   fatJetNVertexTracks[OBJECTARRAYSIZE];
  int   fatJetNSelectedTracks[OBJECTARRAYSIZE];
  float fatJetDRSVJet[OBJECTARRAYSIZE];
  float fatJetFlightDist2D[OBJECTARRAYSIZE];
  float fatJetFlightDist2DError[OBJECTARRAYSIZE];
  float fatJetFlightDist3D[OBJECTARRAYSIZE];
  float fatJetFlightDist3DError[OBJECTARRAYSIZE];
  float fatJetSV_x[OBJECTARRAYSIZE];
  float fatJetSV_y[OBJECTARRAYSIZE];
  float fatJetSV_z[OBJECTARRAYSIZE];
  int   fatJetSVNTracks[OBJECTARRAYSIZE];
  float fatJetSVMass[OBJECTARRAYSIZE];
  int   fatJetNRechits[OBJECTARRAYSIZE];
  float fatJetRechitE[OBJECTARRAYSIZE];
  float fatJetRechitT[OBJECTARRAYSIZE];
  float fatJetRechitT_rms[OBJECTARRAYSIZE];
  float fatJetRechitE_Error[OBJECTARRAYSIZE];
  float fatJetRechitT_Error[OBJECTARRAYSIZE];
  float fatJetGammaMax[OBJECTARRAYSIZE];
  float fatJetGammaMax_ET[OBJECTARRAYSIZE];
  float fatJetGammaMax_EM[OBJECTARRAYSIZE];
  float fatJetGammaMax_Hadronic[OBJECTARRAYSIZE];
  float fatJetAlphaMax[OBJECTARRAYSIZE];
  float fatJetBetaMax[OBJECTARRAYSIZE];
  float fatJetPtAllTracks[OBJECTARRAYSIZE];
  float fatJetPtAllPVTracks[OBJECTARRAYSIZE];
  float fatJetMedianTheta2D[OBJECTARRAYSIZE];
  float fatJetMedianIP[OBJECTARRAYSIZE];
  float fatJetMinDeltaRAllTracks[OBJECTARRAYSIZE];
  float fatJetMinDeltaRPVTracks[OBJECTARRAYSIZE];
